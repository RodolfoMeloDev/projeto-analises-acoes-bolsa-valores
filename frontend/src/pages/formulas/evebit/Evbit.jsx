...
import { getTickersEvEbit } from "../../../utils/funcoesFormula";
...
const EvEbit = ({ logout }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const responseFormula = await getTickersEvEbit(filters);
  ...
  return (
    <div id="frmFormulaEvEbit" className="mt-3">
      <h3>Formula Ev/Ebit</h3>
