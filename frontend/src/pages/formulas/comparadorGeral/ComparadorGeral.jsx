...
import { getTickersCompareAllFormulas } from "../../../utils/funcoesFormula";
...
import {
  ...
  tooltipTextoPayout,
  tooltipTextoPosicaoEvEbit,
  tooltipTextoPosicaoGreenblatt,
  tooltipTextoPosicaoPrecoLucro,
...
const cabecalhoTabela = [
  ...
  {
    label: colunaGridFormulaPosicaoGreenblatt,
    tooltip: tooltipTextoPosicaoGreenblatt,
  },
  {
    label: colunaGridFormulaPosicaoEvEbit,
    tooltip: tooltipTextoPosicaoEvEbit,
  },
  {
    label: colunaGridFormulaPosicaoPrecoLucro,
    tooltip: tooltipTextoPosicaoPrecoLucro,
  },
  {
    label: colunaGridFormulaPrecoJustoBazin,
    tooltip: null,
  },
  {
    label: colunaGridFormulaDescontoBazin,
    tooltip: null,
  },
  {
    label: colunaGridFormulaPrecoJustoGraham,
    tooltip: null,
  },
  {
    label: colunaGridFormulaDescontoGraham,
    tooltip: null,
  },
  {
    label: colunaGridFormulaPrecoJustoGordon,
    tooltip: null,
  },
  {
    label: colunaGridFormulaDescontoGordon,
    tooltip: null,
  },
  {
...
const ComparadorGeral = () => {
  ...
  return (
    <div id="frmFormulaComparadorGeral" className="mt-3">
      <h3>Comparador Geral de Formulas</h3>
...
export default ComparadorGeral;
