  ...
  return (
    <FormGroup className="border rounded p-2 filtroMargemEbit">
      <FormLabel className="d-flex justify-content-between">
        ...
        <OverlayTrigger
          overlay={
            <Tooltip id="tooltip-margemEbit">
              Útil para comparar a lucratividade operacional de empresas do
              mesmo segmento, além de contribuir para avaliar o crescimento da
